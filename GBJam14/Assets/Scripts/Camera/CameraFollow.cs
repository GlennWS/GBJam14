...
public class CameraFollow : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        if (boundsSource != null)
        {
            ...
            desired.x = b.size.x <= halfW * 2f ? b.center.x : Mathf.Clamp(desired.x, b.min.x + halfW, b.max.x - halfW);
            desired.y = b.size.y <= halfH * 2f ? b.center.y : Mathf.Clamp(desired.y, b.min.y + halfH, b.max.y - halfH);
        }
